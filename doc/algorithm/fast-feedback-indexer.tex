...
\subsection{Selecting Final Solutions}
...
To address some of the issues in Section \ref{subsec:approxsol}, we first define a score for the $m$th best approximated spot by a unit cell candidate $\mat{B}$ as shown in Algorithm \ref{alg:mthbest}.
