...
*Luis Barba* from the Swiss Data Science Center has done an implementation with PyTorch. (link: https://github.com/SwissDataScienceCenter/toro-indexer-for-serial-crystallography)
